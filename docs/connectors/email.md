...
> **See [`examples/alarm_to_workorder/`](https://github.com/LGDiMaggio/machina/blob/main/examples/alarm_to_workorder/agent.py)** for a workflow that includes a `notify_technician` step.
